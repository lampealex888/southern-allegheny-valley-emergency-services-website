...
const backup_data = {
      ...
      "nodes": [
        {
          ...
          "apparatus": {
            ...
            "image": {
              "node": {
                "mediaItemUrl": "http://southern-allegheny-valley-emergency-services.local/wp-content/uploads/2024/03/01364086750.jpg"
              }
            }
          }
        },
        {
          ...
          "apparatus": {
            ...
            "image": {
              "node": {
                "mediaItemUrl": "http://southern-allegheny-valley-emergency-services.local/wp-content/uploads/2024/03/01313447556.jpg"
              }
            }
          }
        },
        ...
        },
        {
          ...
          "apparatus": {
            ...
            "image": {
              "node": {
                "mediaItemUrl": "http://southern-allegheny-valley-emergency-services.local/wp-content/uploads/2024/03/01313446036.jpg"
              }
            }
          }
        }
  ...
  "extensions": {
    "debug": [],
    "queryAnalyzer": {
      "keys": "a6ac8165cbcce84eb51d3af13607b0c3c3fc265d8e345d57985f6f028db519c7 graphql:Query list:post cG9zdDo1MA== cG9zdDo0OA== cG9zdDo0Ng== cG9zdDo0NA== cG9zdDozMQ== cG9zdDoyNg== cG9zdDoyNA== cG9zdDo0MQ==",
      "keysLength": 192,
      "keysCount": 11,
      "skippedKeys": "",
      "skippedKeysSize": 0,
...
async function getPosts() {
  if (process.env.NODE_ENV === "development") {
    return backup_data.data.posts.nodes;
  }
